...
public class Constants {
    static final public int TYPE_MEMO = 1;
    static final public int TYPE_MEMO_DATE = 2;
    static final public int TYPE_MEMO_DAILY = 3;
    static final public int TYPE_EDUCATION = 4;
    ...
    static final public int CHECK_INTERVAL = 6 * 1000 * 60 * 60 * 60;
